...
+ pgm_빛의 경로 사이클(DFS) : 매우 오래 걸려서 푼 문제.. 보고 상기정도만
+ pgm_다단계 칫솔 판매(graph) : 다 맞았는데 25~27라인이 살림
+ pgm_순위 검색(구현) : 구현 방법 다시 보기, 이진탐색 구현 부분 복습, 32~34라인 -> map{String($0)} 때문에 시간초과났음 

+ boj1305_광고(String)
+ boj1509_1,2,3 더하기 4(DP) : 언제까지 못풀래...
